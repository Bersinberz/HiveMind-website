const getRecruitmentProgressHtml = (stage: 1 | 2 | 3) => {
...
const getCandidateEmailLayout = (
    ...
    statusColorOptions: { border: string; bg: string; text: string } = { border: "rgba(255, 193, 7, 0.2)", bg: "rgba(255, 193, 7, 0.03)", text: "#FFC107" }
) => {
...
export const getCandidateWelcomeEmail = (fullname: string, dept: string, year: string, registerNumber: string) => {
    const paragraphs = [
...
export const getCandidateAcceptanceEmail = (fullname: string) => {
    ...
    return getCandidateEmailLayout(
        ...
        "",
        specialBannerHtml,
        { border: "rgba(16, 185, 129, 0.3)", bg: "rgba(16, 185, 129, 0.03)", text: "#10B981" }
    );
};

export const getCandidateRejectionEmail = (fullname: string) => {
    const paragraphs = [
    ...
    return getCandidateEmailLayout(
        ...
        "",
        "",
        { border: "rgba(255, 255, 255, 0.15)", bg: "rgba(255, 255, 255, 0.02)", text: "#888888" }
    );
};
